...
namespace Iconic_WIS_NS\StellarWP\Telemetry\Exit_Interview;
...
use Iconic_WIS_NS\StellarWP\Telemetry\Contracts\Template_Interface;
...
class Template implements Template_Interface {
	 ...
	 * @since 1.0.0
	 *
	 * @var \Iconic_WIS_NS\StellarWP\ContainerContract\ContainerInterface
	 */
	protected $container;
	 ...
	 * @since 1.0.0
	 *
	 * @param \Iconic_WIS_NS\StellarWP\ContainerContract\ContainerInterface $container The container.
	 */
