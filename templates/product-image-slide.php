...
$images = $iconic_woo_image_swap_class->get_product_images( $iconic_woo_image_swap_class->settings['effects_slide_image_count'], $product_id );
...
$classes[]    = 'iconic-wis-product-image--slide';
$classes[]    = 'iconic-wis-product-image--' . $iconic_woo_image_swap_class->settings['effects_slide_mode'] . '-slide'; ?>
