...
if ( ! class_exists( 'Iconic_WIS_Settings_Framework' ) ) {
	/**
	 * Iconic_WIS_Settings_Framework class
	 */
	class Iconic_WIS_Settings_Framework {
		/**
		 * Settings wrapper.
		 *
		 * @var array
		...
		/**
		 * Iconic_WIS_Settings_Framework constructor.
		 *
