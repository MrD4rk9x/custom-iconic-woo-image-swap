...
if ( class_exists( 'Iconic_WIS_Compat_Woodmart' ) ) {
	return;
}

/**
 * Woodmart theme compatibility class.
 */
class Iconic_WIS_Compat_Woodmart {
	/**
	 * Init.
	 */
	...
	public static function add_product_image_classes( $classes ) {
		$classes[] = 'iconic-wis-product-image--woodmart';
