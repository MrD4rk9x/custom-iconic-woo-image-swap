...
if ( class_exists( 'Iconic_WIS_Core_Cross_Sells' ) ) {
	return;
}

/**
 * Iconic_WIS_Core_Cross_Sells.
 *
 * @class    Iconic_WIS_Core_Cross_Sells
 * @version  1.0.0
 */
class Iconic_WIS_Core_Cross_Sells {
	/**
	 ...
	 *
	 * @var Iconic_WIS_Core_License_Uplink
	 */
	...
	public static function get_plugin() {
		$class_name = 'Iconic_Woo_Image_Swap';
	...
	public static function get_api_sidebars() {
		...
		$sidebars  = self::get_remote_data( 'iconic_api_sidebars_iconic-wis', '/wp-json/wp/v2/iconic-api-sidebars?plugin_id=iconic-wis', $base_url );
